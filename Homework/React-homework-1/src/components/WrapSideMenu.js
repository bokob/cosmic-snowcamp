  ...
  return (
    <div id="wrapSideMenu">
      <main>
        ...
        <div className="wrap_side_service_menu">
          <ul>
            <li>
              <a
            ...
            <li>
              ...
              >
                <span className="bar_left"></span>브런치 책방<span className="bar_right"></span>
              </a>
            </li>
          </ul>

          <div className="wrap_side_setting wrap_find_user" style={{ position: 'absolute' }}>
